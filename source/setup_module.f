...
c     array allocation parameters (set by subroutine parset)
      ...
      integer torder,maxparnode,lattlim

      real mactheta

      logical taylortree,tricubictree!,marsden
      ...
      save torder,maxparnode,lattlim,mactheta,taylortree,tricubictree
c      save marsden
...
c======== tree parameters========================================================
        ...
        elseif(findstring('torder',record,idum))then

          torder=intstr(record,lenrec,idum)

        elseif(findstring('parnode',record,idum))then
        
          maxparnode=intstr(record,lenrec,idum)
            
        elseif(findstring('mactheta',record,idum))then

          mactheta=dblstr(record,lenrec,idum)

        elseif(findstring('lattlim',record,idum))then

          lattlim=intstr(record,lenrec,idum)

        elseif(findstring('taylor',record,idum))then

          taylortree=.true.

        elseif(findstring('tricubic',record,idum))then

          tricubictree=.true.

c        elseif(findstring('marsden',record,idum))then
