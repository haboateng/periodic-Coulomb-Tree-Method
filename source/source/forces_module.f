...
c***********************************************************************
      ...
      logical lsolva,lfree,lghost,llsolva,ltree
...
c     treecode approximation
      
      if(ltree) then
        
        call treecode(imcon,engacc,viracc,epsq,idnode,mxnode,nstep)
...
c     Ewald sum
      ...
      if(lewald.or.lspme.or.lhke.or.ltree)then
...
c     calculate correction terms
          ...
          elseif(ltree)then
            ...
            call tree_excl(i,ii,engacc,viracc,eps)
